...
class Base extends Controller
{
    ...
    public function register()
    {
        if ($this->request->isAjax()) {
            ...
            //查询渠道来源
            $sourceid = model('Business.Source')->where(['name' => '云商城'])->value('id');
    ...
    public function check()
    {
        if ($this->request->isAjax()) {
            ...
            if ($business) {
                $this->success('用户存在', '/business/base/index', $business);
                exit;
            } else {
                $this->error('用户不存在');
                exit;
